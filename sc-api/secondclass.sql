...
CREATE TABLE `t_organization_apply`  (
  ...
  `o_app_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `o_app_status` varchar(255) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT '未审核',
...
CREATE TABLE `t_user`  (
  ...
  `oid` bigint(0) NULL DEFAULT NULL COMMENT '所属组织（为空时代表没有加入组织）',
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, '123456', 123456, 1, 1, '小明');
INSERT INTO `t_user` VALUES (2, '123456', 12345, 1, 1, '小红');
