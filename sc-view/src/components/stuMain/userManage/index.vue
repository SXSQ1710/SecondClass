                                    ...
                                    <el-row :gutter="10">
                                        <el-col :span="8">
                                            <el-card shadow="hover" button
                                                body-style="text-align:center;color:green;text-shadow:0 0 1px"  @click="getShi(shiTotal_1, shiTotal_2,1)">1</el-card>
                                        </el-col>
                                        <el-col :span="8">
                                            <el-card shadow="hover" button
                                                body-style="text-align:center;color:green;text-shadow:0 0 1px"  @click="getShi(shiTotal_1, shiTotal_2,2,G)">2</el-card>
                                        </el-col>
                                        <el-col :span="8">
                                            <el-card shadow="hover" button
                                                body-style="text-align:center;color:green;text-shadow:0 0 1px"  @click="getShi(shiTotal_1, shiTotal_2,3,G)">3</el-card>
                                        </el-col>
